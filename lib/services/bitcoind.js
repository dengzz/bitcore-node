...
Bitcoin.prototype.getNetworkInfo = function(callback) {
  ...
  this.client.getNetworkInfo(function(err, response) {
    ...
    var info = {
      ...
      relayFee: result.relayfee,
      localAddresses: result.localaddresses,
...
Bitcoin.prototype.getMemPoolInfo = function(callback) {
  var self = this;
  this.client.getMemPoolInfo(function(err, response) {
    ...
    var info = {
      ...
      memPoolMinfee: result.mempoolminfee
    };
    callback(null, info);
  });
};
...
Bitcoin.prototype.getBlockChainInfo = function(callback) {
  ...
  this.client.getBlockChainInfo(function(err, response) {
    ...
    var info = {
      ...
      chainwork: result.chainwork,
      sizeOnDisk: result.size_on_disk,
